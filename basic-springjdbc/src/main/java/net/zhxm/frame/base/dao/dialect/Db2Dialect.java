...
public class Db2Dialect implements IDialect {
	...
	public String getPageSql(String sql, String orderby, Page page) {
		...
		sb.append(sql);
		sb
				.append("  ) frame_sql_temp_table WHERE frame_sql_temp_table.frame_page_sql_row_number >= ");
		sb.append(satrt).append(" and frame_sql_temp_table.frame_page_sql_row_number<=")
				.append(end);
